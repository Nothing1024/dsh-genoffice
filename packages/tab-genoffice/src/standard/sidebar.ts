...
export const GENOFFICE_TAB_ID = '@deepseek-ai/dsh-tab-genoffice'
export const GENOFFICE_FILE_KIND = 'genoffice-file'
export const GENOFFICE_FILE_TAB_ID = '@deepseek-ai/dsh-tab-genoffice/file'
...
export interface SessionListSnapshot {
  ...
  readonly byId?: Record<string, { cwd?: string } | undefined>
}

export type UseSessions = <Selected>(
  selector: (sessions: SessionListSnapshot) => Selected,
) => Selected
