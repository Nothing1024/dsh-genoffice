window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/wt-artifact/packages/host/directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".KeBrkW_dialog.KeBrkW_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.KeBrkW_editorScope{display:contents}.KeBrkW_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.KeBrkW_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.KeBrkW_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.KeBrkW_crumbBar:has(.KeBrkW_crumbEditZone:enabled:hover),.KeBrkW_crumbBar:has(.KeBrkW_crumbEditZone:focus-visible),.KeBrkW_crumbBar:has(.KeBrkW_pathInput){border-color:var(--dsw-alias-border-l2)}.KeBrkW_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.KeBrkW_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.KeBrkW_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.KeBrkW_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.KeBrkW_crumb:hover{color:var(--dsw-alias-label-primary)}.KeBrkW_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.KeBrkW_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.KeBrkW_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.KeBrkW_crumbEditZone:enabled:hover .KeBrkW_crumbEditGlyph,.KeBrkW_crumbEditZone:focus-visible .KeBrkW_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.KeBrkW_crumbEditZone:disabled{cursor:default}.KeBrkW_crumbEditZone:disabled .KeBrkW_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.KeBrkW_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.KeBrkW_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.KeBrkW_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.KeBrkW_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.KeBrkW_rowSeat{flex:none;display:flex}.KeBrkW_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.KeBrkW_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.KeBrkW_rowSelected,.KeBrkW_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.KeBrkW_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.KeBrkW_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.KeBrkW_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.KeBrkW_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.KeBrkW_status,.KeBrkW_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.KeBrkW_status{color:var(--dsw-alias-label-secondary)}.KeBrkW_error{color:var(--dsw-alias-state-error-primary)}.KeBrkW_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.KeBrkW_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.KeBrkW_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.KeBrkW_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.KeBrkW_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.KeBrkW_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.KeBrkW_footerGap{flex:1 1 0}.KeBrkW_footerAction{min-width:72px}.KeBrkW_createDialog.KeBrkW_createDialog{gap:0;width:min(380px,100%);padding:0}.KeBrkW_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.KeBrkW_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.KeBrkW_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.KeBrkW_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.KeBrkW_createInput::placeholder{color:var(--dsw-alias-label-caption)}.KeBrkW_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		const tagId = "@deepseek-ai/dsh-host-directory-picker-browse/DirectoryBrowser.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-host-directory-picker-browse";
			tag.dataset.pluginCss = tagId;
			tag.textContent = css;
			document.head.appendChild(tag);
		}
		var DirectoryBrowser_module_css_default = {
			"crumbSeat": "KeBrkW_crumbSeat",
			"createBody": "KeBrkW_createBody",
			"crumbBar": "KeBrkW_crumbBar",
			"editorScope": "KeBrkW_editorScope",
			"rowIconSelected": "KeBrkW_rowIconSelected",
			"divider": "KeBrkW_divider",
			"createTitle": "KeBrkW_createTitle",
			"rowChevron": "KeBrkW_rowChevron",
			"content": "KeBrkW_content",
			"footerAction": "KeBrkW_footerAction",
			"crumbEditGlyph": "KeBrkW_crumbEditGlyph",
			"rowSelected": "KeBrkW_rowSelected",
			"createDialog": "KeBrkW_createDialog",
			"createInput": "KeBrkW_createInput",
			"crumbTrail": "KeBrkW_crumbTrail",
			"dialog": "KeBrkW_dialog",
			"crumb": "KeBrkW_crumb",
			"error": "KeBrkW_error",
			"title": "KeBrkW_title",
			"crumbChevron": "KeBrkW_crumbChevron",
			"row": "KeBrkW_row",
			"footerBar": "KeBrkW_footerBar",
			"status": "KeBrkW_status",
			"createIn": "KeBrkW_createIn",
			"showHiddenToggle": "KeBrkW_showHiddenToggle",
			"pathInput": "KeBrkW_pathInput",
			"millerRow": "KeBrkW_millerRow",
			"column": "KeBrkW_column",
			"footerGap": "KeBrkW_footerGap",
			"createActions": "KeBrkW_createActions",
			"showHiddenToggleActive": "KeBrkW_showHiddenToggleActive",
			"rowSeat": "KeBrkW_rowSeat",
			"crumbEditZone": "KeBrkW_crumbEditZone",
			"rowName": "KeBrkW_rowName",
			"header": "KeBrkW_header",
			"rowIcon": "KeBrkW_rowIcon",
			"loadingFloat": "KeBrkW_loadingFloat"
		};
		//#endregion
