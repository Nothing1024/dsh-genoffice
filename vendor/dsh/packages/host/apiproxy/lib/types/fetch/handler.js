...
import { workspaceArchiveSessionRequestSchema, workspaceCreateRequestSchema, workspaceDeleteRequestSchema, workspaceInsertSessionBeforeRequestSchema, workspaceListRequestSchema, workspaceRenameRequestSchema, } from "../api/workspace.schema.js";
import { commandExecuteRequestSchema, commandListRequestSchema } from "../api/commands.schema.js";
...
import { subagentHistoryRequestSchema, subagentListRequestSchema, subagentPromptRequestSchema, } from "../api/subagents.schema.js";
const UNARY_ROUTES = {
    ...
    'skill.list': { schema: skillListRequestSchema, invoke: (api, r) => { return api.skills.list(r); } },
