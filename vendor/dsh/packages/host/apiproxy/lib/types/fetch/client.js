...
import { sessionCancelValueSchema, sessionCreateValueSchema, sessionForkValueSchema, sessionHistoryValueSchema, sessionListValueSchema, sessionModelsValueSchema, sessionPromptValueSchema, sessionRenameValueSchema, sessionSearchValueSchema, sessionSelectModelValueSchema, sessionUpdateQueueValueSchema, } from "../api/sessions.schema.js";
import { workspaceArchiveSessionValueSchema, workspaceCreateValueSchema, workspaceDeleteValueSchema, workspaceInsertSessionBeforeValueSchema, workspaceListValueSchema, workspaceRenameValueSchema, } from "../api/workspace.schema.js";
import { commandExecuteValueSchema, commandListValueSchema } from "../api/commands.schema.js";
...
import { subagentHistoryValueSchema, subagentListValueSchema, subagentPromptValueSchema, } from "../api/subagents.schema.js";
/**
...
export class AbstractApiClient {
    ...
    sessions = {
        ...
        rename: (payload, signal) => { return this.callUnary('session.rename', payload, signal); },
