...
var SessionPersistenceJsonl = class extends SessionPersistence {
	...
	*/
	async readPrefix(path, expectedId, signal) {
		...
		} else prefix = await this.readZstdPrefix(buffer, signal);
		signal?.throwIfAborted();
