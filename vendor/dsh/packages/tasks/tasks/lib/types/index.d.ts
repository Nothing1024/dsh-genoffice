...
export type { TaskDoneListener, TaskHooks, TaskKind, TaskKindMap, TaskOutcome, TaskRead, TaskSnapshot, TaskStart, TaskStatus, } from './types.ts';
 ...
 */
export declare abstract class TaskService extends Service {
