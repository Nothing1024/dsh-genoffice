...
function carrierKeyOf(value) {
	if (!isScopeCarrier(value)) return;
	return carrierKeys.get(value);
}
//#endregion
export { AnonymousEntries, NamedEntries, ScopedLayers, carrierKeyOf, createScope, isScopeCarrier, scopeOf, scopeTarget };
