window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-message-feedback/src/client/MessageFeedbackActions.module.css.mjs
		const css = ".WdK9jq_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.WdK9jq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.WdK9jq_action:disabled{cursor:default;opacity:.4}.WdK9jq_action[data-active]{color:var(--dsw-alias-label-primary)}.WdK9jq_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;font-size:13px;line-height:28px;overflow:hidden}.WdK9jq_noteOpen:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.WdK9jq_noteEditor{align-items:flex-start;gap:6px;display:inline-flex}.WdK9jq_noteInput{border:1px solid var(--dsw-alias-border-secondary);background:var(--dsw-alias-bg-primary);width:260px;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.WdK9jq_noteSave,.WdK9jq_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.WdK9jq_noteSave{background:var(--dsw-alias-interactive-bg-primary);color:var(--dsw-alias-label-inverse)}.WdK9jq_noteSave:disabled{cursor:default;opacity:.4}.WdK9jq_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.WdK9jq_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.WdK9jq_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:28px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"action": "WdK9jq_action",
			"noteEditor": "WdK9jq_noteEditor",
			"noteSave": "WdK9jq_noteSave",
			"noteCancel": "WdK9jq_noteCancel",
			"failure": "WdK9jq_failure",
			"noteInput": "WdK9jq_noteInput",
			"noteOpen": "WdK9jq_noteOpen"
		};
		//#endregion
