window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/nothing/workspace/dsh/wt-artifact/packages/client/ui-plan/src/client/PlanModeControl.module.css.mjs
		const css = ".LLPoIa_wrap{align-items:center;gap:6px;display:inline-flex}.LLPoIa_chip{background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.LLPoIa_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}.LLPoIa_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}.LLPoIa_chip:disabled{opacity:.6;cursor:default}.LLPoIa_close{color:currentColor;align-items:center;display:inline-flex}.LLPoIa_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
