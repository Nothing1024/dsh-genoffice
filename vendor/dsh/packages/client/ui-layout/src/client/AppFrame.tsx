...
export type AppFrameProps =
  & PropsRuntime<'root'>
  & PropsRenderSlots<'sidebar' | 'conversation' | 'tabs'>
 ...
 */
function DragHandle(props: { side: 'sidebar' | 'tabs'; left: number; onStart: () => void; onDrag: (dx: number) => void; onEnd: () => void }) {
...
export function AppFrame({
  ...
  const onTabsDrag = useCallback((dx: number) => {
  ...
  return (
    ...
    >
      ...
      <DragHandle side="tabs" left={viewport - cols.details} onStart={onTabsStart} onDrag={onTabsDrag} onEnd={onDragEnd} />
    </div>
  )
}
