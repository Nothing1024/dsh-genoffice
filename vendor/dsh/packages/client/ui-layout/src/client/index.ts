...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    // The right-rail tabs column (artifact profile): same owner share as the
    // sidebar; TabsRoot projects the open tab registry inside it.
    'tabs': { kind: 'single'; scope: 'root'; owner: SidebarOwnerProps }
