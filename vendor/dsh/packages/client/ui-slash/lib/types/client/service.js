...
import { SlashController } from "./controller.js";
/** The `ctx.slash` trigger pipeline service (root registry + controller resolution). */
export class SlashService extends Service {
    ...
    sessions() {
        ...
        if (sessions === undefined)
            throw new Error('ui-slash: sessions service unavailable');
        return sessions;
    }
}
