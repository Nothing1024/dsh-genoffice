...
export declare class TestRoot {
     ...
     */
    declare<const D extends ChildrenDecl>(children: D, frame: SlotComponent<ComposedProps<'root', keyof NoInfer<D> & keyof SlotMap & string, undefined, object>>): Promise<void>;
