 ...
 */
import type { IApiClient, ModelCatalogFailure, ModelProviderGroup, ModelTarget, SessionId, SessionModels } from '@deepseek-ai/dsh-client-connection/client';
...
export declare class ModelDirectory {
     ...
     */
    select(target: ModelTarget): Promise<void>;
    /**
