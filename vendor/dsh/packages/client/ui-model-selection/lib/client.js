window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".Zuy_iW_root{min-width:0;position:relative}.Zuy_iW_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.Zuy_iW_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Zuy_iW_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.Zuy_iW_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Zuy_iW_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Zuy_iW_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.Zuy_iW_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.Zuy_iW_chevronOpen{transform:rotate(180deg)}.Zuy_iW_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.Zuy_iW_status,.Zuy_iW_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.Zuy_iW_error,.Zuy_iW_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.Zuy_iW_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.Zuy_iW_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.Zuy_iW_groups{min-height:0;overflow-y:auto}.Zuy_iW_group+.Zuy_iW_group{margin-top:4px}.Zuy_iW_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.Zuy_iW_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.Zuy_iW_option:hover:not(:disabled),.Zuy_iW_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.Zuy_iW_selected{background:0 0}.Zuy_iW_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Zuy_iW_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.Zuy_iW_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.Zuy_iW_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.Zuy_iW_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.Zuy_iW_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.Zuy_iW_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.Zuy_iW_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.Zuy_iW_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.Zuy_iW_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"triggerEffort": "Zuy_iW_triggerEffort",
			"groupTitle": "Zuy_iW_groupTitle",
			"selected": "Zuy_iW_selected",
			"check": "Zuy_iW_check",
			"cellLabel": "Zuy_iW_cellLabel",
			"cellValue": "Zuy_iW_cellValue",
			"cellChevron": "Zuy_iW_cellChevron",
			"group": "Zuy_iW_group",
			"optionCopy": "Zuy_iW_optionCopy",
			"description": "Zuy_iW_description",
			"modelName": "Zuy_iW_modelName",
			"error": "Zuy_iW_error",
			"root": "Zuy_iW_root",
			"groups": "Zuy_iW_groups",
			"cell": "Zuy_iW_cell",
			"triggerLabel": "Zuy_iW_triggerLabel",
			"status": "Zuy_iW_status",
			"chevron": "Zuy_iW_chevron",
			"menu": "Zuy_iW_menu",
			"empty": "Zuy_iW_empty",
			"warning": "Zuy_iW_warning",
			"chevronOpen": "Zuy_iW_chevronOpen",
			"option": "Zuy_iW_option",
			"trigger": "Zuy_iW_trigger",
			"retry": "Zuy_iW_retry"
		};
		//#endregion
