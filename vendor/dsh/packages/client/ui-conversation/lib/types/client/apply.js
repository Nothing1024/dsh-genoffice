...
import { resolveToolPath } from "./contract/tool-call-model.js";
...
import { bashToolviewSample } from "./toolviews/bash-sample.js";
import { readToolview } from "./toolviews/read-row.js";
import { fileMutationToolview } from "./toolviews/file-mutation-row.js";
import { searchToolview } from "./toolviews/search-row.js";
import { webToolview } from "./toolviews/web-row.js";
import { ApprovalPanel } from "./skeleton/ApprovalPanel.js";
import { todoToolview } from "./toolviews/todo-row.js";
import { askQuestionToolview } from "./toolviews/ask-question-row.js";
...
export function apply(ctx) {
    ...
    slots.register({
        ...
        children: {
            ...
            // tool name, exactly like the chat toolview (a feature plugin registers
            // a richer output surface, e.g. ui-artifact's document rendering); the
            // fallback at the render site is the panel's card-model rendering, so
            // unregistered tools behave exactly as before (UF-002).
