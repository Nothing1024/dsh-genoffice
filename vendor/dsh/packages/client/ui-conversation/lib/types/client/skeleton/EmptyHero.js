...
export function HeroShell({ t, children }) {
    return (_jsxs("div", { className: css.root, children: [_jsxs("div", { className: css.stack, children: [_jsxs("div", { className: css.headline, children: [_jsx(FishLogo, { size: 34, className: css.fish }), _jsx("span", { className: css.headlineText, children: t('hero.headline') }), _jsx("span", { className: css.previewBadge, children: t('hero.preview') })] }), _jsx("div", { className: css.body })] }), children] }));
}
