...
import { type DiffCardModel } from '../contract/diff-card-model.ts';
import { type ReadCardModel } from '../contract/read-card-model.ts';
import { type SearchCardModel } from '../contract/search-card-model.ts';
...
export declare function ToolRow({ t, variant, toolName, icon, title, summary, body, output, errorSummary, terminal, diff, read, search, web, state, filePath, onOpenFile, inspect, }: ToolRowProps): import("react").JSX.Element;
