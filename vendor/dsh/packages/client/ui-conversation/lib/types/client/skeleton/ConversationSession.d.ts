 ...
 */
export declare function ConversationSession({ useSession, useInput, inputActions, useStore, actions, renderSlot, views, bindDraftMirror, }: ConversationSessionProps): import("react").JSX.Element | null;
