 ...
 */
export declare function MessageIconActions({ text, time, runMs, ttftMs, tokensPerSecond, clock, onBranch, branchUnavailable, showBranch, className, t, }: MessageIconActionsProps): import("react").JSX.Element;
