...
type AssistantNode = Extract<ConversationSnapshot['nodes'][number], {
    kind: 'assistant';
}>;
/**
 ...
 */
export declare function deriveTurnMetrics(nodes: ConversationSnapshot['nodes']): Map<number, TurnMetrics>;
export {};
