...
export function InputBar({ useSession, useInput, inputActions, keyboard, resolveSubmitMode, toggleCommandMenu, stop, command, t, renderSlot, useNotices, useLexicon, useMenuLauncher, useProjection, sessionId, variant, disabled: inert = false, placeholder, accessory, overlay, leftItems, rightItems, footer, }) {
    ...
    const onChange = (e) => {
        if (keyboard === undefined)
            return; // absent machine: disabled textarea, no events
        if (machineBusy)
