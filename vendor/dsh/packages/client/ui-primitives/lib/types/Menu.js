...
export function Menu({ open, anchor, items, selectedId, onSelect, onClose, align = 'start', side = 'bottom', portal = false, closeOnPointerLeave = false, compact = false, getAnchorRect, footer, className }) {
    ...
    const list = open && (_jsxs("div", { ref: listRef, className: clsx(css.list, compact && css.compactList, scrollable && css.scrollable, portal && css.portal, side === 'top' && !portal && css.sideTop, align === 'end' && !portal && css.alignEnd), style: portal ? fixedPos ?? MEASURE_STYLE : undefined, role: "menu", 
