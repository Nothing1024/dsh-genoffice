 ...
 */
export function Tooltip({ label, side = 'right', delayMs = 0, disabled = false, children }) {
    ...
    return (_jsxs(_Fragment, { children: [cloneElement(children, {
            ...
            }), pos !== null && (_jsx("span", { ref: bubble, className: css.bubble, "data-side": side, style: { left: pos.x, top: pos.y }, role: "tooltip", children: label }))] }));
}
