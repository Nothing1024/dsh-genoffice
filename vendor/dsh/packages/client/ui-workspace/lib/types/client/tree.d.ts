 ...
 * remains visible.
 */
import type { PendingInteractionStatus, SessionId, SessionListState, SessionSearchResultItem, WorkspaceId, WorkspaceView } from '@deepseek-ai/dsh-client-runtime/client';
