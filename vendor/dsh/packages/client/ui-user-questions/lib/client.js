window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".LOL9oG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.LOL9oG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.LOL9oG_card,.LOL9oG_card *{box-sizing:border-box}.LOL9oG_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.LOL9oG_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.LOL9oG_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.LOL9oG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.LOL9oG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.LOL9oG_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.LOL9oG_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.LOL9oG_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.LOL9oG_card{border-radius:16px}.LOL9oG_body{padding:10px 12px 4px}.LOL9oG_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"feedback": "LOL9oG_feedback",
			"card": "LOL9oG_card",
			"discuss": "LOL9oG_discuss",
			"frame": "LOL9oG_frame",
			"footer": "LOL9oG_footer",
			"body": "LOL9oG_body",
			"strip": "LOL9oG_strip",
			"dot": "LOL9oG_dot",
			"actions": "LOL9oG_actions"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".kHn7KG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.kHn7KG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.kHn7KG_card,.kHn7KG_card *{box-sizing:border-box}.kHn7KG_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.kHn7KG_headingBlock{min-width:0}.kHn7KG_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.kHn7KG_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.kHn7KG_detail{margin:0 2px 8px}.kHn7KG_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.kHn7KG_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.kHn7KG_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.kHn7KG_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.kHn7KG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.kHn7KG_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.kHn7KG_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.kHn7KG_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.kHn7KG_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.kHn7KG_option:hover:not(:disabled),.kHn7KG_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.kHn7KG_optionSelected{border-color:var(--dsw-alias-border-l2)}.kHn7KG_option:disabled{cursor:default}.kHn7KG_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.kHn7KG_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.kHn7KG_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.kHn7KG_checkbox>svg{grid-area:1/1}.kHn7KG_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.kHn7KG_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.kHn7KG_optionCopy{flex:1;min-width:0}.kHn7KG_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.kHn7KG_optionLabel{font-size:14px;font-weight:500;line-height:24px}.kHn7KG_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.kHn7KG_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.kHn7KG_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.kHn7KG_customRow:hover,.kHn7KG_customRow:focus-within,.kHn7KG_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.kHn7KG_customRow:focus-within,.kHn7KG_customRowActive{border-color:var(--dsw-alias-border-l2)}.kHn7KG_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.kHn7KG_customInput::placeholder{color:var(--dsw-alias-label-caption)}.kHn7KG_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.kHn7KG_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.kHn7KG_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.kHn7KG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.kHn7KG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.kHn7KG_card{border-radius:16px}.kHn7KG_header{padding:10px 12px 0 18px}.kHn7KG_options{padding:4px 8px}.kHn7KG_title{font-size:15px;line-height:21px}.kHn7KG_option,.kHn7KG_customRow{padding:8px 6px}.kHn7KG_footer{align-items:flex-end;padding:0 10px}.kHn7KG_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.kHn7KG_option,.kHn7KG_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"checkboxChecked": "kHn7KG_checkboxChecked",
			"progress": "kHn7KG_progress",
			"customTextarea": "kHn7KG_customTextarea",
			"footer": "kHn7KG_footer",
			"checkbox": "kHn7KG_checkbox",
			"optionLabel": "kHn7KG_optionLabel",
			"headingBlock": "kHn7KG_headingBlock",
			"body": "kHn7KG_body",
			"customRow": "kHn7KG_customRow",
			"footerActions": "kHn7KG_footerActions",
			"optionSelected": "kHn7KG_optionSelected",
			"optionLine": "kHn7KG_optionLine",
			"iconButton": "kHn7KG_iconButton",
			"title": "kHn7KG_title",
			"feedback": "kHn7KG_feedback",
			"description": "kHn7KG_description",
			"option": "kHn7KG_option",
			"badge": "kHn7KG_badge",
			"customInput": "kHn7KG_customInput",
			"header": "kHn7KG_header",
			"customRowActive": "kHn7KG_customRowActive",
			"eyebrow": "kHn7KG_eyebrow",
			"frame": "kHn7KG_frame",
			"detail": "kHn7KG_detail",
			"pager": "kHn7KG_pager",
			"card": "kHn7KG_card",
			"number": "kHn7KG_number",
			"optionCopy": "kHn7KG_optionCopy",
			"options": "kHn7KG_options"
		};
		//#endregion
