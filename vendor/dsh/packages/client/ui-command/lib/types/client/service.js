...
export class CommandService extends Service {
    ...
    constructor(ctx) {
        ...
        if (connection === undefined)
            throw new Error('ui-command: connection service unavailable');
        ...
        if (slash === undefined)
            throw new Error('ui-command: slash service unavailable');
    ...
    sessions() {
        ...
        if (sessions === undefined)
            throw new Error('ui-command: sessions service unavailable');
        return sessions;
    }
}
