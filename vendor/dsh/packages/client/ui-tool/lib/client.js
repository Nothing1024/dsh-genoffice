window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".iQ0bhW_root{flex-direction:column;display:flex}.iQ0bhW_row{position:relative;overflow:hidden}.iQ0bhW_root[data-state=running] .iQ0bhW_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite iQ0bhW_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes iQ0bhW_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.iQ0bhW_leading{flex-shrink:0}.iQ0bhW_root[data-tool^=cordis_] .iQ0bhW_leading,.iQ0bhW_root[data-tool^=cordis_] .iQ0bhW_title{color:var(--dsw-alias-state-business-primary)}.iQ0bhW_root[data-tool^=cordis_] .iQ0bhW_title{font-weight:500}.iQ0bhW_root[data-tool^=cordis_] .iQ0bhW_sep{background:var(--dsw-alias-state-business-primary)}.iQ0bhW_chevron{color:var(--dsw-alias-label-secondary)}.iQ0bhW_title{font-weight:400}.iQ0bhW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.iQ0bhW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.iQ0bhW_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.iQ0bhW_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.iQ0bhW_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.iQ0bhW_errorSummary{color:var(--dsw-alias-state-error-primary)}.iQ0bhW_bodyWrap{flex-direction:column;display:flex}.iQ0bhW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.iQ0bhW_root:hover .iQ0bhW_inspectButton,.iQ0bhW_inspectButton:focus-visible{opacity:1}.iQ0bhW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.iQ0bhW_bodyScroll{max-height:260px;overflow-y:auto}.iQ0bhW_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.iQ0bhW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.iQ0bhW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.iQ0bhW_ioSection::-webkit-scrollbar-track{margin:6px 0}.iQ0bhW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.iQ0bhW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.iQ0bhW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.iQ0bhW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.iQ0bhW_codeBody,.iQ0bhW_terminalBody,.iQ0bhW_diffBody,.iQ0bhW_readBody,.iQ0bhW_searchBody,.iQ0bhW_webBody{margin:4px 0 4px 4px}.iQ0bhW_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.iQ0bhW_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.iQ0bhW_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.iQ0bhW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"ioCard": "iQ0bhW_ioCard",
			"codeBody": "iQ0bhW_codeBody",
			"diffBody": "iQ0bhW_diffBody",
			"dsh-tool-row-sweep": "iQ0bhW_dsh-tool-row-sweep",
			"row": "iQ0bhW_row",
			"sep": "iQ0bhW_sep",
			"terminalBody": "iQ0bhW_terminalBody",
			"leading": "iQ0bhW_leading",
			"ioSection": "iQ0bhW_ioSection",
			"searchRecovery": "iQ0bhW_searchRecovery",
			"visuallyHidden": "iQ0bhW_visuallyHidden",
			"chevron": "iQ0bhW_chevron",
			"root": "iQ0bhW_root",
			"summarySuffix": "iQ0bhW_summarySuffix",
			"ioDivider": "iQ0bhW_ioDivider",
			"summary": "iQ0bhW_summary",
			"inspectButton": "iQ0bhW_inspectButton",
			"title": "iQ0bhW_title",
			"searchBody": "iQ0bhW_searchBody",
			"ioLabel": "iQ0bhW_ioLabel",
			"readBody": "iQ0bhW_readBody",
			"bodyWrap": "iQ0bhW_bodyWrap",
			"errorSummary": "iQ0bhW_errorSummary",
			"ioText": "iQ0bhW_ioText",
			"webBody": "iQ0bhW_webBody",
			"fileLink": "iQ0bhW_fileLink",
			"bodyScroll": "iQ0bhW_bodyScroll"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".FNwEhG_callRow{border-radius:6px}.FNwEhG_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"subCalls": "FNwEhG_subCalls",
			"callRow": "FNwEhG_callRow"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".PMCKKG_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.PMCKKG_cardBody{margin:0}.PMCKKG_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.PMCKKG_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.PMCKKG_code[data-error]{color:var(--dsw-alias-state-error-primary)}.PMCKKG_read,.PMCKKG_web{margin:0}.PMCKKG_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			...
			"empty": "PMCKKG_empty",
			"web": "PMCKKG_web",
			"description": "PMCKKG_description",
			"code": "PMCKKG_code",
			"recovery": "PMCKKG_recovery",
			"cardBody": "PMCKKG_cardBody"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".K6luyG_card{flex-direction:column;display:flex}.K6luyG_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.K6luyG_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.K6luyG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.K6luyG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.K6luyG_ioSection::-webkit-scrollbar-track{margin:6px 0}.K6luyG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.K6luyG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.K6luyG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.K6luyG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.K6luyG_root[data-expandable]{cursor:pointer}.K6luyG_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.K6luyG_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite K6luyG_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes K6luyG_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.K6luyG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.K6luyG_chevron{color:var(--dsw-alias-label-secondary)}.K6luyG_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.K6luyG_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.K6luyG_root:hover .K6luyG_iconIdle{opacity:0}.K6luyG_root:hover .K6luyG_chevronHover{opacity:1}.K6luyG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.K6luyG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.K6luyG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.K6luyG_errorSummary{color:var(--dsw-alias-state-error-primary)}.K6luyG_bodyWrap{flex-direction:column;display:flex}.K6luyG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.K6luyG_card:hover .K6luyG_inspectButton,.K6luyG_inspectButton:focus-visible{opacity:1}.K6luyG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.K6luyG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"root": "K6luyG_root",
			"inspectButton": "K6luyG_inspectButton",
			"sep": "K6luyG_sep",
			"errorSummary": "K6luyG_errorSummary",
			"chevron": "K6luyG_chevron",
			"visuallyHidden": "K6luyG_visuallyHidden",
			"summary": "K6luyG_summary",
			"bodyWrap": "K6luyG_bodyWrap",
			"chevronHover": "K6luyG_chevronHover",
			"iconIdle": "K6luyG_iconIdle",
			"title": "K6luyG_title",
			"ioText": "K6luyG_ioText",
			"ioLabel": "K6luyG_ioLabel",
			"ioDivider": "K6luyG_ioDivider",
			"card": "K6luyG_card",
			"leading": "K6luyG_leading",
			"ioCard": "K6luyG_ioCard",
			"ioSection": "K6luyG_ioSection",
			"dsh-bash-row-sweep": "K6luyG_dsh-bash-row-sweep",
			"terminal": "K6luyG_terminal"
		};
		//#endregion
