window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".ti2gbW_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.ti2gbW_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = "._2oCsLa_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._2oCsLa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._2oCsLa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._2oCsLa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._2oCsLa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._2oCsLa_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}._2oCsLa_selector:disabled{cursor:default}._2oCsLa_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"rowText": "_2oCsLa_rowText",
			"desc": "_2oCsLa_desc",
			"chevron": "_2oCsLa_chevron",
			"title": "_2oCsLa_title",
			"selector": "_2oCsLa_selector",
			"row": "_2oCsLa_row"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = ".axd8vG_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.axd8vG_seat:not(:disabled):hover,.axd8vG_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.axd8vG_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.axd8vG_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.axd8vG_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both axd8vG_seat-icon-in}@keyframes axd8vG_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.axd8vG_introText{white-space:pre;display:inline-block}.axd8vG_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards axd8vG_seat-char-in;display:inline-block}@keyframes axd8vG_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.axd8vG_introIcon,.axd8vG_introChar{opacity:1;animation:none}}.axd8vG_chevron{color:var(--dsw-alias-label-caption);flex:none}.axd8vG_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.axd8vG_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.axd8vG_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"itemDesc": "axd8vG_itemDesc",
			"introChar": "axd8vG_introChar",
			"introText": "axd8vG_introText",
			"seat": "axd8vG_seat",
			"item": "axd8vG_item",
			"itemName": "axd8vG_itemName",
			"seatIcon": "axd8vG_seatIcon",
			"chevron": "axd8vG_chevron",
			"seat-char-in": "axd8vG_seat-char-in",
			"introIcon": "axd8vG_introIcon",
			"seat-icon-in": "axd8vG_seat-icon-in"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".suWSSG_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.suWSSG_title{margin:0;font-size:18px;font-weight:600}.suWSSG_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.suWSSG_group{flex-direction:column;gap:10px;display:flex}.suWSSG_group+.suWSSG_group{margin-top:20px}.suWSSG_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.suWSSG_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.suWSSG_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.suWSSG_card:hover:not(.suWSSG_cardActive){border-color:var(--dsw-alias-label-dimmed)}.suWSSG_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.suWSSG_cardBroken,.suWSSG_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.suWSSG_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.suWSSG_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.suWSSG_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.suWSSG_cardMain:disabled{cursor:default}.suWSSG_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.suWSSG_cardHead{align-items:center;gap:8px;display:flex}.suWSSG_cardName{font-size:15px;font-weight:600;line-height:1.4}.suWSSG_badge,.suWSSG_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.suWSSG_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.suWSSG_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.suWSSG_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.suWSSG_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.suWSSG_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.suWSSG_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.suWSSG_iconButton:disabled{opacity:.4;cursor:default}.suWSSG_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.suWSSG_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.suWSSG_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.suWSSG_iconButton:hover:after,.suWSSG_iconButton:focus-visible:after{opacity:1}.suWSSG_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.suWSSG_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.suWSSG_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.suWSSG_revealedPathLabel{white-space:nowrap}.suWSSG_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.suWSSG_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.suWSSG_secondaryButton:disabled{opacity:.5;cursor:default}.suWSSG_field{flex-direction:column;gap:6px;display:flex}.suWSSG_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.suWSSG_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.suWSSG_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.suWSSG_input::placeholder{color:var(--dsw-alias-label-dimmed)}.suWSSG_dialog{width:min(560px,100%)}.suWSSG_dialogFields{flex-direction:column;gap:12px;display:flex}.suWSSG_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.suWSSG_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.suWSSG_deleteDialog{width:min(480px,100%)}.suWSSG_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.suWSSG_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.suWSSG_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.suWSSG_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.suWSSG_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"cardBrokenReason": "suWSSG_cardBrokenReason",
			"cardDesc": "suWSSG_cardDesc",
			"dialog": "suWSSG_dialog",
			"cardActive": "suWSSG_cardActive",
			"iconDanger": "suWSSG_iconDanger",
			"card": "suWSSG_card",
			"secondaryButton": "suWSSG_secondaryButton",
			"input": "suWSSG_input",
			"cards": "suWSSG_cards",
			"badge": "suWSSG_badge",
			"cardFoot": "suWSSG_cardFoot",
			"iconButton": "suWSSG_iconButton",
			"fieldLabel": "suWSSG_fieldLabel",
			"brokenBadge": "suWSSG_brokenBadge",
			"cardMain": "suWSSG_cardMain",
			"deleteConfirm": "suWSSG_deleteConfirm",
			"revealedPathLabel": "suWSSG_revealedPathLabel",
			"section": "suWSSG_section",
			"groupHead": "suWSSG_groupHead",
			"cardBroken": "suWSSG_cardBroken",
			"cardHead": "suWSSG_cardHead",
			"viewerCode": "suWSSG_viewerCode",
			"group": "suWSSG_group",
			"cardName": "suWSSG_cardName",
			"cardId": "suWSSG_cardId",
			"field": "suWSSG_field",
			"revealedPath": "suWSSG_revealedPath",
			"dialogFields": "suWSSG_dialogFields",
			"creatorButton": "suWSSG_creatorButton",
			"intro": "suWSSG_intro",
			"deleteDialog": "suWSSG_deleteDialog",
			"title": "suWSSG_title",
			"inUse": "suWSSG_inUse",
			"error": "suWSSG_error"
		};
