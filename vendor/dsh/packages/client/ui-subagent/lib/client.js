window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/nothing/workspace/dsh/wt-artifact/packages/client/ui-subagent/src/client/SubagentCatalogAction.module.css.mjs
		const css$1 = ".SzmRlG_root{position:relative}.SzmRlG_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.SzmRlG_count{margin:0 5px}.SzmRlG_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.SzmRlG_trigger:hover,.SzmRlG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.SzmRlG_trigger svg{transition:transform .12s}.SzmRlG_triggerOpen{transform:rotate(180deg)}.SzmRlG_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.SzmRlG_node{min-width:0;position:relative}.SzmRlG_menu>.SzmRlG_node{margin-left:-3px}.SzmRlG_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.SzmRlG_row:hover>.SzmRlG_clickarea,.SzmRlG_row:focus-visible>.SzmRlG_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.SzmRlG_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.SzmRlG_row>[data-state],.SzmRlG_clickarea>[data-state]{margin-top:4px}.SzmRlG_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.SzmRlG_disabled:hover{background:0 0}.SzmRlG_loadingRow{cursor:default}.SzmRlG_disclosure,.SzmRlG_disclosureSpace{flex:none;width:14px;height:18px}.SzmRlG_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.SzmRlG_disclosure:hover{color:var(--dsw-alias-label-primary)}.SzmRlG_disclosureOpen{transform:rotate(90deg)}.SzmRlG_content{flex-direction:column;flex:1;min-width:0;display:flex}.SzmRlG_label,.SzmRlG_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.SzmRlG_label{color:inherit;font-weight:400}.SzmRlG_summary,.SzmRlG_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.SzmRlG_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.SzmRlG_metricToken{grid-row:1;line-height:18px}.SzmRlG_metricDuration{grid-row:2}.SzmRlG_children{margin-left:18px;padding-left:4px;position:relative}.SzmRlG_children:before,.SzmRlG_children>.SzmRlG_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.SzmRlG_children:before{height:26px;top:-26px}.SzmRlG_children[aria-busy=true]:before{content:none}.SzmRlG_children>.SzmRlG_node:before{top:0;bottom:0;left:-4px}.SzmRlG_children>.SzmRlG_node:last-child:before{height:17px;bottom:auto}.SzmRlG_children>.SzmRlG_node>.SzmRlG_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.SzmRlG_notice,.SzmRlG_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.SzmRlG_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.SzmRlG_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.SzmRlG_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"disclosureSpace": "SzmRlG_disclosureSpace",
			"disclosure": "SzmRlG_disclosure",
			"disabled": "SzmRlG_disabled",
			"activitySlot": "SzmRlG_activitySlot",
			"metricToken": "SzmRlG_metricToken",
			"children": "SzmRlG_children",
			"metrics": "SzmRlG_metrics",
			"metricDuration": "SzmRlG_metricDuration",
			"menu": "SzmRlG_menu",
			"trigger": "SzmRlG_trigger",
			"error": "SzmRlG_error",
			"refresh": "SzmRlG_refresh",
			"disclosureOpen": "SzmRlG_disclosureOpen",
			"row": "SzmRlG_row",
			"node": "SzmRlG_node",
			"label": "SzmRlG_label",
			"count": "SzmRlG_count",
			"triggerOpen": "SzmRlG_triggerOpen",
			"clickarea": "SzmRlG_clickarea",
			"loadingRow": "SzmRlG_loadingRow",
			"summary": "SzmRlG_summary",
			"root": "SzmRlG_root",
			"content": "SzmRlG_content",
			"notice": "SzmRlG_notice"
		};
		//#endregion
		...
		function summarizeDescendants(sessionId, summaries) {
			let count = 0;
			let running = false;
		...
		*/
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: descendants.running && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, { state: "ongoing" })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "SCW0cG_frame" };
		//#endregion
		...
		*/
		function SubagentReadOnlyComposer({ matched, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				role: "status",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t(!oneShot ? "readonly.title" : "readonly.oneShot.title") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(oneShot ? "readonly.oneShot.body" : "readonly.body") })]
			});
		}
		//#endregion
