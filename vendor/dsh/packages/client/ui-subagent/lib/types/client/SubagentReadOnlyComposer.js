...
export function SubagentReadOnlyComposer({ matched, t, }) {
    ...
    return (_jsxs("div", { className: css.frame, role: "status", children: [_jsx("strong", { children: t(!oneShot ? 'readonly.title' : 'readonly.oneShot.title') }), _jsx("span", { children: t(oneShot ? 'readonly.oneShot.body' : 'readonly.body') })] }));
}
