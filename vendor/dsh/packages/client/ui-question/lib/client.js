window.__ModuleLoader__.load({
	id: "@deepseek-ai/dsh-client-ui-question",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/wt-artifact/packages/client/ui-question/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".OdXCqq_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.OdXCqq_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.OdXCqq_card,.OdXCqq_card *{box-sizing:border-box}.OdXCqq_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.OdXCqq_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.OdXCqq_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.OdXCqq_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.OdXCqq_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.OdXCqq_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.OdXCqq_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.OdXCqq_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.OdXCqq_card{border-radius:16px}.OdXCqq_body{padding:10px 12px 4px}.OdXCqq_footer{align-items:flex-end;padding:8px 12px 10px}}";
		const tagId$1 = "@deepseek-ai/dsh-client-ui-question/PlanReviewPanel.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$1) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-question";
			tag.dataset.pluginCss = tagId$1;
			tag.textContent = css$1;
			document.head.appendChild(tag);
		}
		var PlanReviewPanel_module_css_default = {
			"discuss": "OdXCqq_discuss",
			"footer": "OdXCqq_footer",
			"body": "OdXCqq_body",
			"feedback": "OdXCqq_feedback",
			"card": "OdXCqq_card",
			"dot": "OdXCqq_dot",
			"strip": "OdXCqq_strip",
			"frame": "OdXCqq_frame",
			"actions": "OdXCqq_actions"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/wt-artifact/packages/client/ui-question/src/client/QuestionComposer.module.css.mjs
		const css = ".T8gHUG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.T8gHUG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.T8gHUG_card,.T8gHUG_card *{box-sizing:border-box}.T8gHUG_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.T8gHUG_headingBlock{min-width:0}.T8gHUG_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.T8gHUG_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.T8gHUG_detail{margin:0 2px 8px}.T8gHUG_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.T8gHUG_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.T8gHUG_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.T8gHUG_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.T8gHUG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.T8gHUG_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.T8gHUG_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.T8gHUG_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.T8gHUG_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.T8gHUG_option:hover:not(:disabled),.T8gHUG_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.T8gHUG_optionSelected{border-color:var(--dsw-alias-border-l2)}.T8gHUG_option:disabled{cursor:default}.T8gHUG_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.T8gHUG_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.T8gHUG_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.T8gHUG_checkbox>svg{grid-area:1/1}.T8gHUG_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.T8gHUG_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.T8gHUG_optionCopy{flex:1;min-width:0}.T8gHUG_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.T8gHUG_optionLabel{font-size:14px;font-weight:500;line-height:24px}.T8gHUG_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.T8gHUG_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.T8gHUG_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.T8gHUG_customRow:hover,.T8gHUG_customRow:focus-within,.T8gHUG_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.T8gHUG_customRow:focus-within,.T8gHUG_customRowActive{border-color:var(--dsw-alias-border-l2)}.T8gHUG_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.T8gHUG_customInput::placeholder{color:var(--dsw-alias-label-caption)}.T8gHUG_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.T8gHUG_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.T8gHUG_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.T8gHUG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.T8gHUG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.T8gHUG_card{border-radius:16px}.T8gHUG_header{padding:10px 12px 0 18px}.T8gHUG_options{padding:4px 8px}.T8gHUG_title{font-size:15px;line-height:21px}.T8gHUG_option,.T8gHUG_customRow{padding:8px 6px}.T8gHUG_footer{align-items:flex-end;padding:0 10px}.T8gHUG_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.T8gHUG_option,.T8gHUG_customRow{transition:none}}";
		const tagId = "@deepseek-ai/dsh-client-ui-question/QuestionComposer.module.css";
		...
		var QuestionComposer_module_css_default = {
			"progress": "T8gHUG_progress",
			"optionLabel": "T8gHUG_optionLabel",
			"headingBlock": "T8gHUG_headingBlock",
			"number": "T8gHUG_number",
			"footerActions": "T8gHUG_footerActions",
			"card": "T8gHUG_card",
			"eyebrow": "T8gHUG_eyebrow",
			"detail": "T8gHUG_detail",
			"customRow": "T8gHUG_customRow",
			"header": "T8gHUG_header",
			"title": "T8gHUG_title",
			"feedback": "T8gHUG_feedback",
			"optionCopy": "T8gHUG_optionCopy",
			"iconButton": "T8gHUG_iconButton",
			"optionLine": "T8gHUG_optionLine",
			"customTextarea": "T8gHUG_customTextarea",
			"options": "T8gHUG_options",
			"body": "T8gHUG_body",
			"option": "T8gHUG_option",
			"pager": "T8gHUG_pager",
			"checkbox": "T8gHUG_checkbox",
			"badge": "T8gHUG_badge",
			"optionSelected": "T8gHUG_optionSelected",
			"footer": "T8gHUG_footer",
			"frame": "T8gHUG_frame",
			"customInput": "T8gHUG_customInput",
			"checkboxChecked": "T8gHUG_checkboxChecked",
			"description": "T8gHUG_description",
			"customRowActive": "T8gHUG_customRowActive"
		};
		//#endregion
