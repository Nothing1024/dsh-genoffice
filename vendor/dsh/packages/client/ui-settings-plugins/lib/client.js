window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = ".lsCpta_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.lsCpta_field+.lsCpta_field{border-top:1px solid var(--dsw-alias-border-l2)}.lsCpta_head{align-items:center;gap:8px;display:flex}.lsCpta_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.lsCpta_badges{align-items:center;gap:8px;display:inline-flex}.lsCpta_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.lsCpta_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.lsCpta_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.lsCpta_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.lsCpta_reset:disabled{cursor:default}.lsCpta_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.lsCpta_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.lsCpta_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.lsCpta_inputInvalid{border-color:var(--dsw-alias-label-error);}.lsCpta_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.lsCpta_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"hint": "lsCpta_hint",
			"label": "lsCpta_label",
			"badges": "lsCpta_badges",
			"input": "lsCpta_input",
			"field": "lsCpta_field",
			"inputInvalid": "lsCpta_inputInvalid",
			"badge": "lsCpta_badge",
			"head": "lsCpta_head",
			"badgeMuted": "lsCpta_badgeMuted",
			"reset": "lsCpta_reset",
			"invalid": "lsCpta_invalid"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".oGyQ5W_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.oGyQ5W_card:hover{border-color:var(--dsw-alias-label-dimmed)}.oGyQ5W_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.oGyQ5W_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.oGyQ5W_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.oGyQ5W_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.oGyQ5W_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.oGyQ5W_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.oGyQ5W_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.oGyQ5W_chevronOpen{transform:rotate(180deg)}.oGyQ5W_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.oGyQ5W_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.oGyQ5W_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.oGyQ5W_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.oGyQ5W_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.oGyQ5W_discard,.oGyQ5W_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.oGyQ5W_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.oGyQ5W_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.oGyQ5W_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.oGyQ5W_discard:disabled,.oGyQ5W_save:disabled{opacity:.4;cursor:default}.oGyQ5W_discard:focus-visible,.oGyQ5W_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"cardOpen": "oGyQ5W_cardOpen",
			"pending": "oGyQ5W_pending",
			"name": "oGyQ5W_name",
			"failed": "oGyQ5W_failed",
			"chevron": "oGyQ5W_chevron",
			"chevronOpen": "oGyQ5W_chevronOpen",
			"description": "oGyQ5W_description",
			"header": "oGyQ5W_header",
			"headText": "oGyQ5W_headText",
			"card": "oGyQ5W_card",
			"save": "oGyQ5W_save",
			"footer": "oGyQ5W_footer",
			"readOnly": "oGyQ5W_readOnly",
			"discard": "oGyQ5W_discard",
			"body": "oGyQ5W_body"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = ".ElG3LG_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.ElG3LG_heading{margin:0;font-size:18px;font-weight:600}.ElG3LG_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.ElG3LG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.ElG3LG_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.ElG3LG_tab:hover,.ElG3LG_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.ElG3LG_tab[data-active=true]:after,.ElG3LG_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.ElG3LG_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.ElG3LG_panel{min-width:0;padding-top:2px}.ElG3LG_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.ElG3LG_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"intro": "ElG3LG_intro",
			"heading": "ElG3LG_heading",
			"empty": "ElG3LG_empty",
			"section": "ElG3LG_section",
			"cards": "ElG3LG_cards",
			"panel": "ElG3LG_panel",
			"tab": "ElG3LG_tab",
			"tabs": "ElG3LG_tabs"
