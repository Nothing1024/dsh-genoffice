window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".M87MJW_root{position:relative}.M87MJW_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.M87MJW_trigger:hover,.M87MJW_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.M87MJW_trigger svg{transition:transform .12s}.M87MJW_triggerOpen{transform:rotate(180deg)}.M87MJW_triggerDot{flex:none}.M87MJW_count{margin:0 5px}.M87MJW_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.M87MJW_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.M87MJW_rowSettled{color:var(--dsw-alias-label-tertiary)}.M87MJW_rowDot{flex:none}.M87MJW_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.M87MJW_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.M87MJW_status,.M87MJW_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.M87MJW_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.M87MJW_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"label": "M87MJW_label",
			"duration": "M87MJW_duration",
			"trigger": "M87MJW_trigger",
			"kind": "M87MJW_kind",
			"triggerDot": "M87MJW_triggerDot",
			"triggerOpen": "M87MJW_triggerOpen",
			"rowDot": "M87MJW_rowDot",
			"rowSettled": "M87MJW_rowSettled",
			"status": "M87MJW_status",
			"menu": "M87MJW_menu",
			"root": "M87MJW_root",
			"row": "M87MJW_row",
			"count": "M87MJW_count"
