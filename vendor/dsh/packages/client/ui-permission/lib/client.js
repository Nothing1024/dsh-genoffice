window.__ModuleLoader__.load({
	id: "@deepseek-ai/dsh-client-ui-permission",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/wt-artifact/packages/client/ui-permission/src/client/PermissionRow.module.css.mjs
		const css = ".B1AKQa_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.B1AKQa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.B1AKQa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.B1AKQa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.B1AKQa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.B1AKQa_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.B1AKQa_selector:disabled{cursor:default}.B1AKQa_chevron{flex:none}";
		const tagId = "@deepseek-ai/dsh-client-ui-permission/PermissionRow.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-permission";
		...
		var PermissionRow_module_css_default = {
			"title": "B1AKQa_title",
			"chevron": "B1AKQa_chevron",
			"selector": "B1AKQa_selector",
			"rowText": "B1AKQa_rowText",
			"desc": "B1AKQa_desc",
			"row": "B1AKQa_row"
		};
		//#endregion
		...
		*/
		...
		var PermissionSettingsController = class {
			api;
		...
		*/
		function apply(ctx) {
			...
			const controller = new PermissionSettingsController(ctx.get("connection").api);
			...
			ctx.effect(() => {
				const refresh = (ns) => {
					if (ns !== void 0 && ns !== "permission") return;
