import type { IApiClient, HostFrame, MuxFrame, RpcError, RpcRequest, RpcResult, SessionId, SubagentAddress, SubagentCatalog, WorkspaceId } from '@deepseek-ai/dsh-client-connection/client';
...
export declare class SessionManager {
     ...
     */
    constructor(api: IApiClient, restoredSelection?: SessionId, restoredAddress?: SubagentAddress);
    /**
