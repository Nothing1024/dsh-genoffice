...
import type { DirectoryListing, IApiClient, RpcError, SessionId, WorkspaceId, WorkspaceView } from '@deepseek-ai/dsh-client-connection/client';
...
export declare class WorkspacesService implements IWorkspaces {
