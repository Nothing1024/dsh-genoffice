...
import type { RpcError, SessionId, SubagentAddress, ToolCallView, ToolResultView } from '@deepseek-ai/dsh-client-connection/client';
...
export type ConversationNode = UserMessageNode | AssistantMessageNode | SteeringMessageNode | ContextMessageNode | ModelRetryNode | TurnErrorNode | ToolResultNode | CommandNode | CompactionSummaryNode | UnknownSurfaceNode;
/**
...
export interface ConversationSnapshot {
    ...
    /**
     * In-window `artifact/delta` accumulation by callId: the incrementally
     * generated text of in-flight `create-document` calls (window-derived like
     * `codeDispatches`; the final `tool/result` content remains the complete
     * model-visible payload).
     */
    artifactDeltas: ReadonlyMap<string, string>;
