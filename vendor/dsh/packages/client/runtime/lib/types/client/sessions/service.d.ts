...
import type { IApiClient, RpcError, RpcResult, SessionId, SubagentAddress, WorkspaceId } from '@deepseek-ai/dsh-client-connection/client';
...
export declare class SessionsService implements ISessions {
     ...
     */
    constructor(rootCtx: Context, api: IApiClient);
    /**
