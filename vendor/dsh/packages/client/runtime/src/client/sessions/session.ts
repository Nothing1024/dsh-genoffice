...
export class Session implements SessionFace {
  ...
  private artifactDeltas = new Map<string, string>()
  private deltasRev = 0
  private deltasCache: { rev: number; value: ReadonlyMap<string, string> } | null = null
  ...
  private applyEventSideEffects(event: SessionEvent, view?: ToolEventView): void {
    ...
    if (eventType === 'artifact/delta') {
      ...
      const data = event.data as unknown as { callId?: unknown; delta?: unknown }
