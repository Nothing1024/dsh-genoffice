window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/nothing/workspace/dsh/plugin/dsh-artifact/env/wt-artifact-bs/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = "._iRHtG_dialog._iRHtG_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}._iRHtG_editorScope{display:contents}._iRHtG_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}._iRHtG_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}._iRHtG_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}._iRHtG_crumbBar:has(._iRHtG_crumbEditZone:enabled:hover),._iRHtG_crumbBar:has(._iRHtG_crumbEditZone:focus-visible),._iRHtG_crumbBar:has(._iRHtG_pathInput){border-color:var(--dsw-alias-border-l2)}._iRHtG_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}._iRHtG_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}._iRHtG_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}._iRHtG_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}._iRHtG_crumb:hover{color:var(--dsw-alias-label-primary)}._iRHtG_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}._iRHtG_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}._iRHtG_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}._iRHtG_crumbEditZone:enabled:hover ._iRHtG_crumbEditGlyph,._iRHtG_crumbEditZone:focus-visible ._iRHtG_crumbEditGlyph{color:var(--dsw-alias-label-primary)}._iRHtG_crumbEditZone:disabled{cursor:default}._iRHtG_crumbEditZone:disabled ._iRHtG_crumbEditGlyph{color:var(--dsw-alias-label-caption)}._iRHtG_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}._iRHtG_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}._iRHtG_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}._iRHtG_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}._iRHtG_rowSeat{flex:none;display:flex}._iRHtG_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}._iRHtG_row:hover{background:var(--dsw-alias-interactive-bg-hover)}._iRHtG_rowSelected,._iRHtG_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}._iRHtG_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}._iRHtG_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}._iRHtG_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}._iRHtG_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}._iRHtG_status,._iRHtG_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}._iRHtG_status{color:var(--dsw-alias-label-secondary)}._iRHtG_error{color:var(--dsw-alias-state-error-primary)}._iRHtG_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}._iRHtG_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}._iRHtG_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}._iRHtG_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}._iRHtG_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}._iRHtG_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}._iRHtG_footerGap{flex:1 1 0}._iRHtG_footerAction{min-width:72px}._iRHtG_createDialog._iRHtG_createDialog{gap:0;width:min(380px,100%);padding:0}._iRHtG_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}._iRHtG_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}._iRHtG_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}._iRHtG_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}._iRHtG_createInput::placeholder{color:var(--dsw-alias-label-caption)}._iRHtG_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"rowSelected": "_iRHtG_rowSelected",
			"rowChevron": "_iRHtG_rowChevron",
			"createActions": "_iRHtG_createActions",
			"footerBar": "_iRHtG_footerBar",
			"editorScope": "_iRHtG_editorScope",
			"rowIconSelected": "_iRHtG_rowIconSelected",
			"createIn": "_iRHtG_createIn",
			"title": "_iRHtG_title",
			"rowSeat": "_iRHtG_rowSeat",
			"row": "_iRHtG_row",
			"createDialog": "_iRHtG_createDialog",
			"rowIcon": "_iRHtG_rowIcon",
			"crumb": "_iRHtG_crumb",
			"error": "_iRHtG_error",
			"header": "_iRHtG_header",
			"crumbSeat": "_iRHtG_crumbSeat",
			"status": "_iRHtG_status",
			"crumbBar": "_iRHtG_crumbBar",
			"content": "_iRHtG_content",
			"dialog": "_iRHtG_dialog",
			"divider": "_iRHtG_divider",
			"footerGap": "_iRHtG_footerGap",
			"showHiddenToggle": "_iRHtG_showHiddenToggle",
			"millerRow": "_iRHtG_millerRow",
			"crumbChevron": "_iRHtG_crumbChevron",
			"column": "_iRHtG_column",
			"crumbEditGlyph": "_iRHtG_crumbEditGlyph",
			"showHiddenToggleActive": "_iRHtG_showHiddenToggleActive",
			"footerAction": "_iRHtG_footerAction",
			"createBody": "_iRHtG_createBody",
			"crumbEditZone": "_iRHtG_crumbEditZone",
			"rowName": "_iRHtG_rowName",
			"createInput": "_iRHtG_createInput",
			"loadingFloat": "_iRHtG_loadingFloat",
			"pathInput": "_iRHtG_pathInput",
			"crumbTrail": "_iRHtG_crumbTrail",
			"createTitle": "_iRHtG_createTitle"
		};
		//#endregion
