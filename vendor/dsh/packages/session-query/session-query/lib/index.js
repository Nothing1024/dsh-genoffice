...
function traceSession(records, sessionId) {
	...
	for (const children of childrenByParent.values()) children.sort((a, b) => {
...
*/
var SessionQueryService = class extends Service {
...
//#endregion
export { SESSION_QUERY_DEFAULT_PERSISTED_INSPECT_CONCURRENCY, SESSION_QUERY_READ_WINDOW_MAX, SessionQueryError, SessionQueryService, SessionQueryService as default, SessionSearchCursor, assertSessionHeadersCompatible, buildSessionEventRecords, buildSessionEventSearchDocuments, compileSessionTextFilter, extractSessionEventText, filterSessionEventDocuments, filterSessionResults, materializeSessionEventResultFilters, materializeSessionResultFilters };
