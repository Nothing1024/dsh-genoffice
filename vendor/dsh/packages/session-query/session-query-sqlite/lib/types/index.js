...
import SessionQueryService, { SESSION_QUERY_DEFAULT_PERSISTED_INSPECT_CONCURRENCY, SESSION_QUERY_READ_WINDOW_MAX, SessionQueryError, SessionSearchCursor, assertSessionHeadersCompatible, buildSessionEventSearchDocuments, } from '@deepseek-ai/dsh-session-query';
...
function resolveConfig(config) {
    ...
    const openPhases = ['startup', 'first-search'];
