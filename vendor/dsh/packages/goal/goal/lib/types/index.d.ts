...
import type { GoalBlockReason, GoalProjection, GoalRef } from './types.ts';
import type { CreateGoalRequest, EditGoalRequest, GoalView } from './domain.ts';
...
export declare class GoalService extends Service {
