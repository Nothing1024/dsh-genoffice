...
*/
var SubprocessService = class extends Service {
	constructor(ctx) {
		super(ctx, "subprocess");
	}
};
//#endregion
export { DSH_ENV_PREFIX, SENSITIVE_ENV_PATTERN, SubprocessService, SubprocessService as default, scrubbedParentEnv };
