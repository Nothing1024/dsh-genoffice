...
*/
var Settings = class extends Service {
	...
	*/
	...
	write(ns, input, mode, expectedRevision) {
		...
		const snapshot = cloneJsonShaped(payload, (label, path) => /* @__PURE__ */ new TypeError(`settings ${verb} for "${ns}" must be JSON-shaped data (found ${label} at ${path})`));
...
//#endregion
export { Settings, Settings as default, SettingsConflictError, deepEqualJson, installSettingsSection, redactSecrets, settingsNamespace };
